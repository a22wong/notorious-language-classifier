...
Fig.~\ref{confusion_decision_trees} shows the confusion matrix for the Decision Tree classifier.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=80mm]{confusion_decision_tree.png}
\caption{Decision Trees confusion matrix.}
\label{confusion_decision_trees}
\end{figure}
