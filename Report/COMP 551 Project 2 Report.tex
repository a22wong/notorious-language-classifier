...
An optimizer with 180 estimators was able to gain a training accuracy of 97%, as seen by the figure below. The algorithm performs significanctly worse with the test data, leading us to the conclusion that the Extremely Randomized Trees still overfit.
